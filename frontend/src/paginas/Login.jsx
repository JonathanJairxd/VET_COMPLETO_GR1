            ...
            <div className="w-1/2 h-screen bg-white flex justify-center items-center">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className="my-4">
                            <button to="/dashboard" className="py-2 w-full block text-center bg-gray-500 text-slate-300 border rounded-xl hover:scale-100 duration-300 hover:bg-gray-900 hover:text-white">Login</button>
                        </div>
